const PREVIEW_W = 400;
const PREVIEW_H = 360;
export function showImageAdjust(item, onConfirm) {
    var _a, _b, _c;
    let panX = (_a = item.imagePanX) !== null && _a !== void 0 ? _a : 0;
    let panY = (_b = item.imagePanY) !== null && _b !== void 0 ? _b : 0;
    let zoom = (_c = item.imageZoom) !== null && _c !== void 0 ? _c : 1;
    let naturalW = 0;
    let naturalH = 0;
    let coverScale = 1;
    // Backdrop
